...
const Services = () => {
    ...
    return (
        <section className="pt-[2rem] pb-[2rem] px-[7rem]">
            ...
            <div className="mt-[5rem] max-w-[1900px] mx-auto grid grid-cols-3  gap-[2rem]">
                {
            ...
            <div className="pt-[3.5rem] max-w-[1900px] mx-auto pb-[7rem] rounded-[4rem] mt-[5rem] px-[4rem] bg-[#F5F5F5]">
                <h3 className="text-center text-[3rem]">Direct <span className="text-[#1B82E2] font-[600]">Debit</span> Services</h3>

                <p className="mt-[2.5rem] w-[80%] text-[1.8rem] text-center mx-auto text-[#737373]">The methods available for loan collections are just as diverse as the borrowers themselves. One method that stands out for its reliability and directness is Direct Debit. This payment method, accessible to lenders, facilitates the retrieval of funds from a customer's account precisely when their loan payment is due.</p>

                <p className="w-[80%] text-[1.8rem] text-center mx-auto text-[#737373]">
                ...
                <div className="mt-[9rem]">
                    <p className="text-center text-[2rem] font-[500] text-[#737373]">Why you should use Direct Debit Collection Method</p>

                    <div className="grid mt-[3rem] grid-cols-4 gap-[2rem]">
                        {
    ...
    return (
        <div className="bg-[#FFFFFF] rounded-[1.5rem] py-[3rem]">
            <img
                ...
                alt="icon"
                className="mb-[2rem] mx-auto w-[5rem] h-[5rem]"
            />
            <p className="max-w-[18rem] mx-auto text-[1.8rem] text-center font-[500]">{title}</p>
        </div>
    )
}
